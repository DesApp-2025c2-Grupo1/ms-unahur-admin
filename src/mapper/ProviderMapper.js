...
class ProviderMapper {
    map(db) {
        ...
        // Procesar múltiples lugares de atención
        const lugaresAtencion = (db.lugaresAtencion || []).map(raw => {
        ...
        return {
            ...
            especialidades: (db.especialidades || []).map(pe => ({ id: pe.especialidad.idEspecialidad, nombre: pe.especialidad.nombre })),
